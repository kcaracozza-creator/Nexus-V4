...
# InvestmentAnalyzer removed — NEXUS does not generate investment scores,
# buy/sell recommendations, or price targets.
# Deck building optimization (mana curve, synergy) is still available via AdvancedDeckOptimizer.


class AdvancedDeckOptimizer:
    """Advanced deck optimization system — builds optimal decks from inventory"""

    def __init__(self, meta_analyzer=None, investment_analyzer=None):
        self.meta_analyzer = meta_analyzer or AIMetaAnalyzer()
        # investment_analyzer param retained for backward compatibility but not used
...
def main():
    ...
    optimizer = AdvancedDeckOptimizer(meta_analyzer)
