...
try:
    ...
    print("⚠️ Imaging libraries not available - some features will be limited")
...
class CustomCardGenerator:
    ...
    def __init__(self, master_db_path=None):
        ...
        self.output_dir = Path(r"E:\MTTGG\Generated_Cards")
        self.templates_dir = Path(r"E:\MTTGG\Card_Templates")
        ...
        print("🎨 Custom Card Generator initialized")
        self.load_card_data()
    ...
    def load_card_data(self):
        ...
        try:
            if os.path.exists(self.master_db_path):
                ...
                print(f"✅ Loaded {len(self.master_cards)} cards for AI training")
                self.analyze_card_patterns()
            
        except Exception as e:
            print(f"⚠️ Could not load master database: {e}")
    ...
    def setup_templates(self):
        ...
        if not IMAGING_AVAILABLE:
            print("⚠️ Image generation not available - text-only cards")
            return
        
        try:
            # Create basic templates
            self.create_basic_templates()
            print("✅ Card templates ready")
        except Exception as e:
    ...
    def generate_custom_card(self, theme=None, card_type=None, power_level='medium'):
        ...
        print(f"✅ Generated card: {card_data['name']}")
        return {
            'card_data': card_data,
    ...
    def generate_card_set(self, theme, count=5, power_levels=None):
        ...
        print(f"✅ Generated {count}-card set saved to: {set_file}")
...
class DeckThemeAnalyzer:
    ...
    def load_card_database(self):
        ...
        try:
            if os.path.exists(self.master_db_path):
                ...
                print(f"✅ Loaded {len(self.card_database)} cards for theme analysis")
            else:
                print("⚠️ Master database not found - using limited analysis")
        except Exception as e:
    ...
    def analyze_deck_theme(self, deck_list, deck_name="Unknown Deck"):
        ...
        print(f"✅ Theme analysis complete - Score: {analysis['overall_theme_score']:.1f}/100")
        return analysis
...
class AutomatedDeckNamer:
    ...
    def generate_deck_name(self, deck_analysis, style='auto', creativity_level='medium'):
        ...
        print(f"✅ Generated deck name: {best_name}")
        return best_name
...
class StoryGenerator:
    ...
    def generate_deck_story(self, deck_analysis, story_type='full', length='medium'):
        ...
        print(f"✅ Generated {len(story.split())} word story")
        return {
            'story': story,
...
def test_ai_content_creation():
    ...
    try:
        ...
        print(f"✅ Generated card: {card['card_data']['name']}")
    ...
    try:
        ...
        print(f"✅ Generated deck name: {deck_name}")
        
    except Exception as e:
        results['deck_naming'] = {'status': 'ERROR', 'error': str(e)}
        print(f"❌ Deck naming error: {e}")
    ...
    for test_name, result in results.items():
        ...
        emoji = "✅" if status == "PASSED" else "❌" if status == "ERROR" else "⚠️"
...
def create_ai_content_suite():
    ...
    print("✅ AI Content Creation Suite Ready")
...
if __name__ == "__main__":
    ...
    if test_success:
        ...
        print("\\n⚠️ Some features need attention before full deployment")